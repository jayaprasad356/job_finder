...
define('DOMAIN_URL', 'https://jobfinder.graymatterworks.com/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
   ...
   //  private $db_name = "telugu_calendar";    // Change as required
    ...
    //LIVE
    private $db_host = "localhost";  // Change as required
    private $db_user = "u743445510_job_finder";  // Change as required
    private $db_pass = "Job_finders@2023";  // Change as required
    private $db_name = "u743445510_job_finder";    // Change as required
